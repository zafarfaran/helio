...
function IntegrationsSection() {
  return (
    <div>
      <SectionHeader
        title="Integrations"
        description="Connect your tools and data sources to Helio"
      />
...
function NotificationsSection() {
  return (
    <div>
      <SectionHeader
        title="Notifications"
        description="Control how and when Helio alerts you"
      />
      ...
      <Card delay={0.06}>
        ...
        <div className="mt-4 space-y-4">
          <ToggleRow
            ...
            description="Show observation badges as Helio analyses client data"
            defaultOn
          />
          <ToggleRow
  ...
  return (
    <div>
      ...
      <Card delay={0.06}>
        ...
        <p className="text-[11px] font-light text-slate-500 dark:text-zinc-400 mt-1 mb-4">
          Use API keys to integrate Helio with your own tools
        </p>
