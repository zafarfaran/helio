...
export function HelioLogo({ className = "h-7" }: { className?: string }) {
  return (
    <svg viewBox="0 0 190 32" className={className} aria-label="Helio by Saturn">
      ...
      {/* "by saturn" */}
      <text x="84" y="22" fontFamily="inherit" fontWeight="300" fontSize="9" fill="currentColor" opacity="0.4" letterSpacing="0.04em">by saturn</text>
    </svg>
  );
}
...
export function IconHelioMark({ className = "w-5 h-5" }: { className?: string }) {
  return (
